...
{
	DECL_ID_t	*var_ptr, *last_var;
	TOKEN_t	*token;
	int	token_class;
	BOOLEAN_t	multi_list;
...
{
	DECL_MEMBER_t	*struct_ptr, *last_struct;
	TOKEN_t		token;
	int		token_class;
...
)
{
    ...
    printf("EJD -- now in parse_declare\n");
