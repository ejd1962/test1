 ...
 *	Operator list
 */
RESERVED_OPERATOR_t reserved_operators[] = {
	"+",	"+",	PLUS,
	"-",	"-",	MINUS,
	"*",	"*",	TIMES,
	"/",	"/",	DIVIDE,
 ...
 *	Reserved word list
 */
RESERVED_WORD_t reserved_words[] = {
...
BOOLEAN_t		parsing_literal;
TOKEN_t		literal_token, eof_token;
char		*lit_text_ptr;
...
)
{
    ...
    RESERVED_OPERATOR_t	*op_ptr;
    char		token_ch, last_token;
    char		*token_name_ptr;
    char		*op_name;
    BOOLEAN_t		got_fraction;
    BOOLEAN_t		cvt_case;
